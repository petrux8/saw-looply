...
const HabitStatisticsPage = () => {
  ...
  const completionRate = Math.round((habitHistory.length / (totalDay ? totalDay : 1)) * 100);
  ...
  return (
    <div className="container mt-5">
      <h1 className="mb-4">{habit.name}</h1>
      <div className="row">
        {/* Calendario */}
          ...
          <div className="p-4 bg-white rounded shadow-sm">
            ...
            <table className="table table-striped">
              <tbody>
                ...
                <tr>
                  <td>
                    <i className="bi bi-percent text-info"></i> Completion Rate
                  </td>
